...
interface SettingsDocumentData {
  ...
  /**
   * CTA Phrase field in *Settings*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.cta_phrase
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  cta_phrase: prismic.KeyTextField;
...
/**
 * Primary content in *ProjectLinks → Primary*
 */
export interface ProjectLinksSliceDefaultPrimary {
  /**
   * Github Label field in *ProjectLinks → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_links.primary.github_label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  github_label: prismic.KeyTextField;

  /**
   * Github Link field in *ProjectLinks → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project_links.primary.github_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  github_link: prismic.LinkField;

  /**
   * Preview Label field in *ProjectLinks → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project_links.primary.preview_label
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  preview_label: prismic.KeyTextField;

  /**
   * Preview Link field in *ProjectLinks → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project_links.primary.preview_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
/**
 * Default variation for ProjectLinks Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ProjectLinksSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ProjectLinksSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *ProjectLinks*
 */
type ProjectLinksSliceVariation = ProjectLinksSliceDefault;

/**
 * ProjectLinks Shared Slice
 *
 * - **API ID**: `project_links`
 * - **Description**: ProjectLinks
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ProjectLinksSlice = prismic.SharedSlice<
  "project_links",
  ProjectLinksSliceVariation
>;
...
export interface SkillsSliceDefaultItem {
  /**
   * Name field in *Skills → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: skills.items[].name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  name: prismic.KeyTextField;

  /**
   * icon field in *Skills → Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skills.items[].icon
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ProjectLinksSlice,
      ProjectLinksSliceDefaultPrimary,
      ProjectLinksSliceVariation,
      ProjectLinksSliceDefault,
      SkillsSlice,
